...
**CLIP-seq**和**CHIP-seq**是常见的「高通量测序方法」，两者分析有<font color="red">共通之处但也有明显差异</font>，大家可以**对比着看这两个分析流程**。因为还没进展到具体数据分析，所以只是简略阐述了各个分析步骤及注意事项，未涉及具体软件的比较。可以通过本文来简单入门，深入的学习方法我会未来再整理出来。
